...
---
Update the Karpathy style wiki stored in the hiveplotlib repo as a sub module based on changes that have been made to the tool over the last week. Do a quick lint check of the wiki as well. Then do a quick web search to see if anything interesting with hive plots has come out in the last week, documenting anything accordingly. Do not commit any changes.
